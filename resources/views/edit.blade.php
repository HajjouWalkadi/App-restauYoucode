<x-app-layout>
    ...
    <div class="container items-center">
        <h1 class="col fw-bold mt-3 mb-2 text-center fs-2">Edit Menu</h1>
        </div>
    <!-- edit meal form -->
    <div class="container pt-3 w-50 bg-white rounded">
        <form action="EditMenu/{{$menus->id}}" method="POST" id="form" class=" pb-2" enctype="multipart/form-data">
            @csrf
           ...
           <div class="mb-3">
             ...
             <input type="file" class="form-control border rounded" id="images" name="image" required>
                       ...
                       <div class="mb-0">
                           ...
                           <textarea class="form-control border rounded" name="description" rows="7" >{{$menus->description}}</textarea>
                       </div>

         <div class="mb-3">
                           <label class="form-label">Date</label>
                           <input type="date" name="date" class="form-control rounded" value="{{$menus->date}}" required/>
                       </div>
